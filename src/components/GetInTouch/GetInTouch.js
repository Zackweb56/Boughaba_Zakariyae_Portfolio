      ...
      <div className="getintouch">
        ...
        >
          <div className="get">
            ...
            <img src={Logo} width="40%" className="my-5" alt="new Logog" />
          ...
          <div className="all_links d-flex">
            ...
            <div>
              <ul className="social">
                ...
                <li>
                  <a href="https://wa.me/qr/OK6FDXMFVZOEE1">Whatsapp</a>
                </li>
                <li>
                  <a href="https://github.com/Zackweb56">Github</a>
                </li>
                <li>
                  <a href="https://www.linkedin.com/in/zakaria-boughaba-447318283">
                    Linkedin
                  </a>
                </li>
                <li>
