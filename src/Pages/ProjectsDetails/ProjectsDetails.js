...
import { FaArrowRightLong, FaCalendar, FaEye, FaUser } from "react-icons/fa6";
        ...
        <div className="post_container">
          <div className="project_details_post">
            <div className="project_image">
              <img
                src={!selectedImage ? project.project_image : selectedImage}
                className="img-fluid"
                ...
                {project.image_gallery.map((image, index) => {
                  return (
                    <img
                      ...
                      src={image.p6img}
                      className={
                        selectedImage === image.p6img
                          ? "active_image_gallery"
                          : ""
                      }
                      onClick={() => handleSelectImage(image.p6img)}
                      alt="img__gallery"
                    />
                  );
                })}
            ...
            <div className="post_infos d-flex justify-content-between align-items-center">
              ...
              <div className="date_author">
                <span className="date mx-2">
                  <FaCalendar /> &nbsp; {project.project_date}
                </span>
            ...
            <p className="tools">
              ...
              <span className="keywords">{project.project_desc}</span>
            </p>
            ...
            <div className="structure">
              ...
              <div>
                <img
                  src={project.project_structure_img}
                  alt="i haven't added it yet, due to the files structure of the laravel and reactJs Projects"
                />
              </div>
            </div>
            <div className="link_preview">
              ...
              <p>
                This Project is Uploaded in my Github Accout, so if you want to
                check all my project i invite you to visit my Github Account
                just <a href="https://github.com/Zackweb56">click Here</a>{" "}
              </p>
              <div className="preview_btn">
                <Button
                  title="Preview"
                  icon={<FaEye />}
                  link={project.project_link_preview}
                />
              </div>
            </div>
          </div>
          <div className="sidebar">
            <div className="categories">
              ...
              {project.project_categories.map((categorie, index) => {
                return <span key={index}>{categorie.categorie}</span>;
              })}
            </div>
            <div className="tags">
