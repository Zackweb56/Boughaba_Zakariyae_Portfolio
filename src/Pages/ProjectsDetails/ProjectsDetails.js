                    ...
                    <div className="project_details_post"> 
                        ...
                        <div className="post_infos d-flex justify-content-between align-items-center">
                            ...
                            <div className="date_author">
                                ...
                                <span className="author mx-2"><FaUser /> &nbsp; zack web</span>
                            </div>
                        </div>
                        ...
                        <div className="features">
                            ...
                            {project.project_features.map((feature,index)=>{
                                return(
                                    <ul key={index}>
                                        <li>{feature.id}. {feature.feature}</li>
                                    </ul>
                                );
                            })}
                        </div>
                        ...
                        <div className="link_preview">
                            ...
                            <p>This Project is Uploaded in my Github Accout, so if you want to check all my project i invite you to visit my Github Account just <a href="https://github.com/Zackweb56">click Here</a> </p>
                            <div className="preview_btn">
                            <Button title="Preview" icon={<FaEye />} link={project.project_link_preview} />
                            </div>
                        </div>
                    </div>
