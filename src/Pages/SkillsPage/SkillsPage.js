...
import Skills_img from "../../assets/skills_img.jpg";
            ...
            <div className="additional_box_container">
              <div class="additional_box">
                ...
                <p>
                  ...
                  networked applications, particularly web services. It adheres
                  to a set of constraints that emphasize the use of standard
              ...
              <div class="additional_box">
                ...
                <p>
                  Cloud Computing (Azure) refers to a comprehensive suite of
                  cloud services and infrastructure solutions provided by
                  Microsoft's Azure platform. Azure allows organizations to
                  deploy, manage, and scale a wide range of applications and
              ...
              <div class="additional_box">
                ...
                <p>
                  ...
                  management and software development, emphasizing
                  collaboration, customer feedback, and the ability to respond
                  to changing requirements. Scrum is a specific Agile framework
                  characterized by small, cross-functional teams that work in
                  short, time-boxed cycles called "sprints."
                </p>
              </div>
              <div class="additional_box">
                <div className="icon">
                ...
                <p>
                  ...
                  tracking changes and collaboration in software development,
                  while GitHub is a web-based platform that hosts Git
                  repositories and provides a user-friendly interface for
