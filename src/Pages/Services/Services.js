        ...
        <section className="service" id="service">
          <div className="box_se-container">
            <div className="box_se">
              ...
              <h3>Web Design</h3>
              <p>
                An effective UI/UX is what captures attention and spreads a
                clear message. I make sure the design is innovative and neat
                with all of this.{" "}
              </p>
            </div>
            ...
            <div className="box_se">
              ...
              <p>
                responsive design is a way to put together a website so that it
                automatically scales its content and elements to match the
                screen size on which it is viewed.
              </p>
            </div>
            ...
            <div className="box_se">
              ...
              <p>
                It’s a good practise to get your logos, images and website done
                from one source. I can help you design those that will fit and
                match into the website and app quickly.{" "}
              </p>
            </div>
          </div>
        </section>
